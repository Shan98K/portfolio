...
// Hover Effects
const interactiveElements = document.querySelectorAll('a, .metric-card, .review-track, .project-visual, .tag-cloud span, .logo, .sound, .bento-item, button, .interactive-card');
